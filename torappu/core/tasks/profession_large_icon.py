...
@task("ProfessionLargeIcon", priority=3, raw_subdir="profession_large_icon")
async def profession_large_icon(
    client: Client,
    output_dir: OutputDir,
    bundles: Annotated[set[str], changed_bundles("arts/profession_large_hub")],
) -> None:
