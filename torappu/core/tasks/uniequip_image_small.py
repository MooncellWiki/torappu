...
@task("UniEquipImageSmall", priority=3, raw_subdir="uniequip_img_small")
async def uniequip_image_small(
    client: Client,
    output_dir: OutputDir,
    bundles: Annotated[set[str], changed_bundles("arts/ui/uniequipimgsmall/")],
) -> None:
