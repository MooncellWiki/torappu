...
@task("RoguelikeTopicItempic", priority=2, raw_subdir="roguelike_topic_itempic")
async def roguelike_topic_itempic(
    client: Client,
    output_dir: OutputDir,
    bundles: Annotated[set[str], changed_bundles("arts/ui/rogueliketopic/itempic")],
) -> None:
