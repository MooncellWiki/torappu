...
@task("UniEquipExtraType", priority=3, raw_subdir="uniequip_extratype")
async def uniequip_extratype(
    client: Client,
    output_dir: OutputDir,
    bundles: Annotated[set[str], changed_bundles("arts/ui/uniequipextratype")],
) -> None:
